      ...
      >
        <div>
          <nuxt-link to="/" class="flex"
            ><img style="width: 30%" src="/img/innovate-logo.png" alt=""
          /></nuxt-link>
        </div>
        ...
        >
          <nav class="flex space-x-10">
            <nuxt-link
              to="/"
              class="hoverable-link text-base font-medium leading-6 text-gray-500 transition duration-150 ease-in-out hover:text-gray-900 focus:outline-none focus:text-gray-900"
            >
              Home
            </nuxt-link>
            <nuxt-link
